...
const socials = [
  {
    ...
    icon: (
      <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
        <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.741l7.732-8.835L1.254 2.25H8.08l4.261 5.632 5.905-5.632zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
      </svg>
    ),
  },
  {
...
export default function Footer() {
  ...
  return (
    <footer ref={footerRef} className={styles.footer}>
      ...
      {/* Back-to-top button on the curve */}
      <button
      ...
      <div className={styles.inner}>
        ...
        <div ref={topRef} className={styles.top}>
          ...
          {/* Logo — uses your actual image file */}
          <a href="#" className={styles.logo}>
            {/*
              Place your logo at /public/logo.svg
              The CSS filter keeps it white on the dark red footer.
              Falls back to text "Pickar" if image is missing.
            */}
            <img
              src="/images/logo.svg"
              alt="Pickar"
